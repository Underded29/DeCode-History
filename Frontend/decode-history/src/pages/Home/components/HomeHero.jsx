...
const HomeHero = () => {
  return (
    ...
    <section className="max-w-3xl mx-auto space-y-6 text-center my-12 md:my-20 px-4">
      ...
      {/* Опис. Замість gray-600 робимо прозорість для brand-dark (text-brand-dark/70) */}
      ...
      {/* Головна кнопка. Враховано ховер через прозорість у Tailwind v4 та тінь під колір бренду */}
      <button className="bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold py-3.5 px-8 rounded-xl shadow-lg shadow-brand-blue/20 transition-all cursor-pointer transform hover:-translate-y-0.5 active:translate-y-0">
        Почати спростування →
      </button>
      ...
      <div className="pt-4 flex items-center justify-center gap-3 text-sm text-brand-dark/60 font-medium">
        <div className="flex -space-x-2">
          {/* Колір обведення аватарів підлаштовано під твій світлий фон сторінки */}
